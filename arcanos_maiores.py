...
{'carta':'O Eremita',
'nome': ' Globo da Invulnerabilidade',
...
'Os Amantes','O Carro de Guerra','A Justiça','O Eremita','A Roda da Fortuna','A Força',
...
def sorte():
   random.shuffle(baralho_tarot)   
   diario = []
   diario.append(baralho_tarot[0:3])  
   print(diario)         
